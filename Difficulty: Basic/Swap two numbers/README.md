<h2><a href="https://www.geeksforgeeks.org/problems/swap-two-numbers3844/1?page=3&difficulty=Basic&sortBy=submissions">Swap two numbers</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 20px;">You are given two numbers a and b. Your task is to swap the given two numbers.</span></p>
